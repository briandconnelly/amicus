...
Its cache-hint clause is superseded by [ADR 0018](0018-the-catalog-carries-a-ttl-and-resource-reads-do-not.md) (2026-09-09); the fingerprint and surface-digest decisions stand.
...
(Superseded by ADR 0018: fastmcp's hint is still uniform, but the SDK beneath it takes one per method, and the volatility is confined to `resources/read`.)
