...
CAPABILITY_SUMMARY = (
    ...
    "error catalog; re-read surface_digest rather than re-walking the catalog, because it "
    "covers exactly the tool, resource and template records plus this text. "
