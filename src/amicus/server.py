...
CAPABILITY_SUMMARY = (
    ...
    "Pass workspace_root from a sessionless (2026-07-28) client on every call whose schema "
    "declares it — all but amicus_backends, amicus_models and amicus_capabilities, which "
    "take no workspace_root and reject one; the server never falls back to its own cwd "
