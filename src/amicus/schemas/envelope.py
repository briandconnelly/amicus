...
_DISCARD_OUTCOME_DESC = (
    ...
    "no longer read as it did when this call returned it (a failed job's result can still "
    "appear), so nothing was deleted. delete_failed: deletion failed or could not be "
